...
| File | Role |
|------|------|
| `lib/ui/avatar/wireframe_motion_registry.dart` | Add new animations here |
| `lib/ui/avatar/wireframe_grip_motion.dart` | Grip-driven motion builder |
| `lib/ui/avatar/body_pose_builder_3d.dart` | `toBackShell`, `setFrontArm` |
| `lib/ui/avatar/test/wireframe_motion_registry_test.dart` | Registry regression tests |
| `lib/ui/avatar/test/wireframe_projection_debug_test.dart` | Screen projection dump |
